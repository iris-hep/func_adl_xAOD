...
EventCollectionSpecification = namedtuple('EventCollectionSpecification', ['backend_name', 'name', 'include_files', 'container_type', 'element_type', 'contains_collection', 'element_pointer'])
