...
class xAODDataset(LocalDataset):
    ...
    def __init__(
        ...
        Note:
            * (R22 Release Notes)[https://twiki.cern.ch/twiki/bin/view/AtlasProtected/AnalysisBaseReleaseNotes22pt2]
        """
    ...
    def docker_cache_volume(self) -> List[docker_volume_info]:
        return [
            docker_volume_info(
                docker_name="atlas_xaod_calibration_cache_r22",
                mount_point="/xaod_calibration_cache",
            )
        ]
