...
class atlas_r22_xaod_event_collection_container(event_collection_container):
...
class atlas_r22_xaod_event_collection_collection(event_collection_collection_container):
    def __init__(
        self,
        type_name: Union[str, ctyp.CPPParsedTypeInfo],
        element_name: Union[str, ctyp.CPPParsedTypeInfo],
        p_depth_type: int = 1,
        p_depth_element: int = 1,
    ):
        super().__init__(
            type_name,
            element_name,
...
atlas_r22_xaod_collections = [
    EventCollectionSpecification(
        ...
        atlas_r22_xaod_event_collection_collection("xAOD::JetContainer", "xAOD::Jet"),
        ["xAODJet"],
    ),
    EventCollectionSpecification(
        "atlas",
        ...
        atlas_r22_xaod_event_collection_collection(
            "xAOD::TrackParticleContainer", "xAOD::TrackParticle"
        ),
        ["xAODTracking"],
    ),
    EventCollectionSpecification(
        ...
        atlas_r22_xaod_event_collection_container("xAOD::EventInfo"),
        ["xAODEventInfo"],
    ),
    EventCollectionSpecification(
        "atlas",
        ...
        atlas_r22_xaod_event_collection_collection(
            "xAOD::TruthParticleContainer", "xAOD::TruthParticle"
        ),
        ["xAODTruth"],
    ),
    EventCollectionSpecification(
        ...
        atlas_r22_xaod_event_collection_collection(
            "xAOD::ElectronContainer", "xAOD::Electron"
        ),
        ["xAODEgamma"],
    ),
    EventCollectionSpecification(
        ...
        atlas_r22_xaod_event_collection_collection("xAOD::MuonContainer", "xAOD::Muon"),
        ["xAODMuon"],
    ),
    EventCollectionSpecification(
        "atlas",
        ...
        atlas_r22_xaod_event_collection_collection(
            "xAOD::MissingETContainer", "xAOD::MissingET"
        ),
        ["xAODMissingET"],
    ),
]
...
def define_default_r22_atlas_types():
    ...
    ctyp.add_method_type_info(
        "xAOD::TruthParticle", "parent", ctyp.terminal("xAOD::TruthParticle", p_depth=1)
    )
    ctyp.add_method_type_info(
        "xAOD::TruthParticle", "child", ctyp.terminal("xAOD::TruthParticle", p_depth=1)
    )


class atlas_r22_event_collection_coder(event_collection_coder):
    def get_running_code(self, container_type: event_collection_container) -> list:
        return [
            f"{container_type} result = 0;",
